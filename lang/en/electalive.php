...
$string['lessthanearlyopen'] = 'Oops! The Teacher Open Time needs to be greater or equal to the Open Time.';
$string['meetingduration'] = 'Session Duration';
$string['meetingends'] = 'End Time';
$string['meetingnotstarted'] = '<div class="alert alert-info">This live session has not opened yet. See the \'When you can enter\' time above.</div>';
$string['meetingon'] = '<div class="alert alert-success">This session is now on. Click the Enter button to launch the session.</div>';
$string['meetingopens'] = 'When you can enter';
$string['meetingover'] = '<div class="alert">This live session is over.</div>';
$string['meetingtime'] = 'Start Time';
$string['meetingtime_help'] = 'The time that the session is scheduled to begin. ';
...
$string['moderatorearlyopen'] = 'Teacher Open Time';
