...
$string['earlyopendesc'] = 'The time in minutes that anyone can enter the classroom before a session\'s start time.';
...
$string['meetingnotstarted'] = 'This live session has not started yet.';
...
$string['moderatorearlyopendesc'] = 'The time in minutes that teachers or instructors can enter the classroom before a session\'s start time. This must equal or be higher than Default Open Time.';
...
$string['sessiondesc'] = 'Session Details';
